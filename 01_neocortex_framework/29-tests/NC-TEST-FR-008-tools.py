...
"""
Teste rpido das ferramentas MCP modularizadas.
"""

import os
import sys

# Adicionar o diretrio atual ao path
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))

# Importar o servidor (isso registrar as ferramentas)
...
if "neocortex_cortex" in mcp.tools:
    ...
    print("Ferramenta cortex no encontrada")
