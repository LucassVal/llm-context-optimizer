...
> **Based on:** v8.0 Orquestrao Completa + Current v4.0 State + Audit Findings
...
##  Stability-First Roadmap (6 Phases)
...
1.  Extended MetricsStore with domainspecific tables  
...
**Created:** 2026-04-10  
**Based on:** v8.0 Orquestrao Completa + v4.0 Current State  
