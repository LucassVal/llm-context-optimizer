...
**Data:** 2026-04-14
O relatrio cruza os 215 arquivos materiais da Teia KGS com as 273 entradas na tabela oficial em `NC-NAM-FR-001`.

** Resumo Executivo**
- **Arquivos Fsicos Indexados:** 215
- **Entradas na Tabela SSOT:** 273
- ** Arquivos Fantasmas (Fsicos NO listados no SSOT):** 107
- ** Links Mortos (Listados no SSOT, mas no existem no disco):** 154
