...
"""---
_genealogy:
  injected_at: '2026-04-16T00:24:01.839764'
...
config_path = r"C:\Users\Lucas Valrio\.gemini\antigravity\mcp_config.json"
...
if "mcpServers" in config and "neocortex" in config["mcpServers"]:
    ...
    neocortex_config["args"] = [
        "C:/Users/Lucas Valrio/Desktop/TURBOQUANT_V42/neocortex_framework/neocortex/mcp/server.py"
    ]
    # Update PYTHONPATH to include framework directory
    neocortex_config["env"] = {
        "PYTHONPATH": "C:/Users/Lucas Valrio/Desktop/TURBOQUANT_V42/neocortex_framework"
    }
