...
**Data da Auditoria:** 2026-04-14T23:51:54.478900
**Ambiente:** original
...
- **Conformidade NC-:** 44.9% (155/345)
- **Arquivos no conformes:** 188

## 2. Dependncias PIP
- **Pacotes instalados:** 299
 ...
 **Status:** True
**Detalhes:** 155 arquivos seguem padro NC-
 ...
 **Status:** True
**Detalhes:** 4 de 9 YAMLs de governana possuem hash

### R01: Inventrio de Ativos de IA: manter catlogo completo de modelos, ferramentas, agentes e fontes de dados
 **Status:** False
**Detalhes:** artifact_catalog.json: False, mcp_tools_inventory.json: False, genealogy_graph.json: True
 ...
 **Status:** True
**Detalhes:** Checkpoint tool exists: True
 ...
 **Status:** True
**Detalhes:** Save point tool exists: True
