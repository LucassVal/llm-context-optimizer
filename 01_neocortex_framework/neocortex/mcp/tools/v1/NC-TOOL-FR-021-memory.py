...
"""---
_genealogy:
  injected_at: '2026-04-16T00:24:00.880248'
  injected_by: NC-SCR-FR-075-genealogy-injector.py
  version: '1.0'
topology: neocortex-other
level: 0
parent_ssot: NC-TOOL-FR-013-manifest
related_ssot:
  - NC-TOOL-FR-021-memory
  - NC-TOOL-FR-001-cortex
  - NC-TOOL-FR-014-search
  - NC-TOOL-FR-009-lobes
  - NC-TOOL-FR-007-init
tags:
  - neocortex-other
  - level-0
...
def register_tool(mcp) -> None:
    ...
    def neocortex_memory(
        ...
        Actions (prefixo lobe., cortex., manifest., search.):
          lobe.list_active, lobe.get_content, lobe.activate, lobe.deactivate,
          lobe.search, lobe.list_all, lobe.get_checkpoint_tree,
          cortex.get_full, cortex.get_section, cortex.get_aliases,
          cortex.get_workflows, cortex.validate_alias,
          manifest.generate, manifest.update, manifest.query,
          manifest.list, manifest.generate_all, search.advanced"""
        #  lobe.list_active
