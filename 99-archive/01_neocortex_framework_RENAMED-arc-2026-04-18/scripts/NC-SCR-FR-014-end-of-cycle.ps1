...
# ──────────────────────────────────────────────
# 7. CONTEXTO DE RETOMADA (GenerateResume)
# ──────────────────────────────────────────────
if ($GenerateResume) {
    Write-Host ''
    Write-Host '--- 7. CONTEXTO DE RETOMADA (cole no início da próxima sessão) ---' -ForegroundColor Magenta
