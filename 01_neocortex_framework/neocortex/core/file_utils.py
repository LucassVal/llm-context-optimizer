"""
file_utils.py — ALIAS SHIM (DEPRECATED)
Replaced by NC-CORE-FR-112-file-utils.py
Preserved for backward compatibility with existing importers.
DO NOT add new imports here. Use NC-CORE-FR-112-file-utils.py directly.
"""
...
_NC_FILE = _Path(__file__).parent / "NC-CORE-FR-112-file-utils.py"
