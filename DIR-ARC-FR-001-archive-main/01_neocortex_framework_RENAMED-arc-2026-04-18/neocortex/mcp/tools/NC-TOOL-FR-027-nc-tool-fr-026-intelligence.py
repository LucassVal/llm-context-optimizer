...
def register_tool(mcp) -> None:
    ...
    def neocortex_intelligence(
        ...
        Args:
            action:          Ao desejada
            prompt:          Prompt para brain.think
            context:         Contexto adicional para brain.think
            goal:            Objetivo para brain.plan
            task_description: Descrio da tarefa para brain.orchestrate
            agent_output:    Output do agente para brain.critique
            feedback_data:   Dados de feedback para brain.feedback (JSON string)
        """
