...
class LexicoBootLoader:
    ...
    def _parse_hook_yaml(self, yaml_path: Path) -> LexicoHookMetadata | None:
    ...
    def _parse_hook_python(self, py_path: Path) -> LexicoHookMetadata | None:
...
_boot_loader_instance: LexicoBootLoader | None = None
