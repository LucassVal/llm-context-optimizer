...
Quando um ticket aprovado  prrequisito para modificar um `@LOCKS`, ele **no** remove o lock diretamente. Em vez disso, gera um patch `NCPATCH{id}{target}.diff` em `DIRDS004patches/` para **T0 aplicar manualmente**.
