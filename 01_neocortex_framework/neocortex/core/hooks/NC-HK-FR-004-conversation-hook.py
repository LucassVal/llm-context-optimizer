...
# Singleton
_hook_instance: Optional[ConversationHook] = None

def get_conversation_hook(config: Optional[Dict] = None) -> ConversationHook:
...
def register_hook(hook_registry_path: Optional[Path] = None) -> bool:
    """
