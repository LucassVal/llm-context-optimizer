...
**Data:** 2026-04-14
O relatrio cruza os 262 arquivos materiais da Teia KGS com as 286 entradas na tabela oficial em `NC-NAM-FR-001`.

** Resumo Executivo**
- **Arquivos Fsicos Indexados:** 262
- **Entradas na Tabela SSOT:** 286
- ** Arquivos Fantasmas (Fsicos NO listados no SSOT):** 162
- ** Links Mortos (Listados no SSOT, mas no existem no disco):** 186
...
- `pyproject.toml`
- `openclaude_pb2_grpc.py`
- `NC-CORE-FR-102-agent-service.py`
- `rules.txt`
...
- `Aqui está o prompt ajustado exatamente c.txt`
- `package.json`
- `NC-TODO-FR-001-project-roadmap.md.bak`
- `NC-SVC-FR-100-mcp-server.py`
- `NC-LBE-FR-ARCHITECTURE-001.mdc`
- `NC-CORE-FR-119-peers-service.py`
- `NC-CFG-DS-002-session-contract.yaml`
- `NC-SCR-FR-159-test-fastmcp-real.py`
- `README.md`
- `requires.txt`
- `ledger_20260410_212708.json`
- `NC-TLM-FR-001-tool-manifest.json`
- `NC-CORE-FR-107-circuit-breaker.py`
- `NC-SCR-FR-158-test-mock-corrected.py`
...
- `AGENTS.md`
- `cache.db`
- `NC-CORE-FR-123-regression-service.py`
- `NC-SCR-FR-151-compliance-audit.py`
- `deepseek.exe`
- `NC-TODO-FR-001-project-roadmap-v7-combined.md`
- `SOURCES.txt`
- `NC-TODO-FR-001-project-roadmap.md.backup`
- `NC-CORE-FR-120-profile-manager.py`
- `NC-DOC-WL-001-hybrid-mode.md`
- `NC-CORE-FR-105-cascade-consolidator.py`
...
- `NC-CORE-FR-101-agent-policy-enforcer.py`
- `06_governance`
- `update_ledger_status.py`
- `NC-CORE-FR-118-manifest-service.py`
- `Sem título.txt`
- `neocortex_mcp.py`
- `index.redb`
...
- `NC-TOOL-FR-020-openclaude-bridge.py`
...
- `top_level.txt`
- `NC-CORE-FR-113-init-service.py`
- `test_tools_simple.py`
- `detalhamento_completo.md`
- `NC-CORE-FR-110-cortex-service.py`
- `01_architecture`
...
- `QUICK_TEST.py`
- `lobe_index.db`
- `NC-CORE-FR-124-security-service.py`
- `7fd282bb51e2535a2323bf377a90.val`
- `NC-LBE-FR-PROFILES-001.mdc`
- `test_config_reload.py`
- `list_tools_simple.py`
- `NC-CORE-FR-116-lexico-service.py`
- `NC-TODO-FR-001-roadmap.yaml`
...
- `NC-CORE-FR-112-file-utils.py`
- `extract_tools_final.py`
- `generate_official_tool_manifest.py`
- `SANITIZATION_CHECKLIST.md`
- `NC-CORE-FR-121-profile-service.py`
- `NC-LBE-FR-DOCUMENTATION-001.mdc`
- `example_architecture.py`
- `NC-CORE-FR-109-consolidation-service.py`
- `📁 SANITIZAÇÃO DA PASTA TURBOQUANT_V42 –.txt`
...
- `NC-CORE-FR-108-config-service.py`
- `memory-ledger-TEMPLATE.json`
- `NC-CORE-FR-104-benchmark-service.py`
- `NC-SCR-FR-160-audit-compliance.py`
- `metrics.db`
- `NC-SCR-FR-157-final-fix.py`
- `benchmark_fractal_gauntlet.py`
- `requirements.txt`
- `NC-LBE-FR-PERFORMANCE-001.mdc`
- `NC-MAP-FR-001-structural-maps.yaml`
- `NC-CORE-FR-125-tool-guard.py`
- `NC-CORE-FR-117-lobe-service.py`
- `NC-CORE-FR-122-pulse-scheduler.py`
- `NC-CORE-FR-111-export-service.py`
- `NC-SCR-FR-152-fix-mcp-governance.py`
...
### ` C:\Users\Lucas Valério\Desktop\TURBOQUANT_V42\02_memory_lobes`
