...
layer: "core"
type: "service"
tags: ["tool", "019", "project", "manifest"]
hash: "auto-generated"
---"""
"""
...
def register_tool(server):
    ...
    def neocortex_project_manifest(action: str, fmt: str = "all", filter_ext: str = "",
        ...
        Actions:
          generate         Executa scan completo e grava arquivos (json/jsonl/md)
          get_boot_context  Retorna string compacta para bootstrap de IA
          get_nc_index     ndice de todos os arquivos NC-* do projeto
          get_structure    Estrutura de diretrios (opcional: filter_ext='.py')
          get_ssot_files   Apenas arquivos SSOT crticos

        Args:
          action: Ao a executar
          fmt: Formato para 'generate' (all|json|md|jsonl) [default: all]
          filter_ext: Filtrar por extenso em 'get_structure' (ex: '.py')
          use_cache: Se True, usa JSON em cache se < 24h [default: True]
        """
