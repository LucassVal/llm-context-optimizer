"""
profile_service.py — ALIAS SHIM (DEPRECATED)
Replaced by NC-CORE-FR-121-profile-service.py
Preserved for backward compatibility with existing importers.
DO NOT add new imports here. Use NC-CORE-FR-121-profile-service.py directly.
"""
...
_NC_FILE = _Path(__file__).parent / "NC-CORE-FR-121-profile-service.py"
